...
### 내가 생각한 근거
- 2019~2020년을 포함하면 어떤 이점이 있는가?
- 그런데도 2021년부터 사용하려는 이유는 무엇인가?
- 더 긴 데이터 기간과 정의 일관성 중 무엇을 우선했는가?

### 예상되는 단점
- 5년으로 제한하면 표본 수와 경기 사이클 관점에서 어떤 정보가 사라지는가?
- 2021~2023년과 2024~2025년의 공간 정의가 완전히 같다고 볼 수 있는가?

### 검증 방법
- 연도별 행 수와 상권 수를 어떻게 비교할 것인가?
- 2023년과 2024년 사이에 코드와 분포가 급변하는지 어떻게 확인할 것인가?
- 전체 기간 모델과 2024년 이후 모델의 성능을 어떻게 비교할 것인가?